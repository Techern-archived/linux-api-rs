//! Bindings to x86 unistd definitions

#[cfg(target_arch = "x86")]
pub mod x86_unistd {
    pub const __NR_RESTART_SYSCALL: ::c_long = 0;

    pub const __NR_EXIT: ::c_long = 1;
    pub const __NR_FORK: ::c_long = 2;
    
    pub const __NR_READ: ::c_long = 3;
    pub const __NR_WRITE: ::c_long = 4;
    
    pub const __NR_OPEN: ::c_long = 5;
    pub const __NR_CLOSE: ::c_long = 6;
    
    pub const __NR_WAITPID: ::c_long = 7;
    
    pub const __NR_CREAT: ::c_long = 8;
    pub const __NR_LINK: ::c_long = 9;
    pub const __NR_UNLINK: ::c_long = 10;
    pub const __NR_EXECVE: ::c_long = 11;
    pub const __NR_CHDIR: ::c_long = 12;
    
    pub const __NR_TIME: ::c_long = 13;
    
    pub const __NR_MKNOD: ::c_long = 14;
    pub const __NR_CHMOD: ::c_long = 15;
    pub const __NR_LCHOWN: ::c_long = 16;
    
    pub const __NR_BREAK: ::c_long = 17; //Huh? This isn't normal, is it?
    
    pub const __NR_OLDSTAT: ::c_long = 18;
    
    pub const __NR_LSEEK: ::c_long = 19;
    
    pub const __NR_GETPID: ::c_long = 20;
    
    pub const __NR_MOUNT: ::c_long = 21;
    pub const __NR_UMOUNT: ::c_long = 22;
    
    pub const __NR_SETUID: ::c_long = 23;
    pub const __NR_GETUID: ::c_long = 24;
    
    pub const __NR_STIME: ::c_long = 25;
    
    pub const __NR_PTRACE: ::c_long = 26;
    pub const __NR_ALARM: ::c_long = 27;
    
    pub const __NR_OLDFSTAT: ::c_long = 28;
    
    pub const __NR_PAUSE: ::c_long = 29;
    pub const __NR_UTIME: ::c_long = 30;
    
    pub const __NR_STTY: ::c_long = 31;
    pub const __NR_GTTY: ::c_long = 32;
    ...
    //pub const __NR_WAITID: ::c_long = 95; Not used?
